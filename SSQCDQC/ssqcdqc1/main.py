...
_CONFIG = torch.Tensor(
    _METADATA_TYPES=torch.Tensor(
        _METADATA_TYPES_ENUM=torch.Tensor(
            artifact="",
            data="",
            data_type="",
            data_shape="",
    ...
    _PIPELINE_COMPONENTS_SPEC_ENUM=dict(
        CsvExampleGen="CsvExampleGenSpec",
        StatisticsGen="StatisticsGenSpec",
        SchemaGen="SchemaGenSpec",
        ExampleValidator="ExampleValidatorSpec",
        Transform="TransformSpec",
    ...
    _PIPELINE_COMPONENTS_SPEC_CHANNEL_ENUM=dict(
        CsvExampleGen="Channel",
        StatisticsGen="Channel",
        SchemaGen="Channel",
        ExampleValidator="Channel",
    ...
    _PIPELINE_COMPONENTS_SPEC_CHANNEL_TYPE_ENUM=dict(
        CsvExampleGen="Artifact",
        StatisticsGen="Artifact",
        SchemaGen="Artifact",
        ExampleValidator="Artifact",
